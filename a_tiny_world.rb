...
class GameWindow < Gosu::Window
  ...
  def initialize
    ...
    @space.add_collision_func(:ground, :mini) do |ground, mini|
      if mini.obj.body.vel.x > 100 && mini.obj.body.pos.y < $screen.height
        mini.obj.slam!
    ...
    @space.add_collision_func(:outsole, :mini) do |outsole, mini|
      ...
      if mini.obj.status == :on_ground && outsole.obj.body.vel.y > 0
        mini.obj.crush!
    ...
    @space.add_collision_func(:outsole, :ground) do |outsole, ground|
      if outsole.obj.body.vel.y > 20
        Sample['16793__pushtobreak__Earth1.ogg'].play(outsole.obj.body.vel.y * 0.005)
      end
    end
